 ...
 * @author 1860915
 */
@WebServlet(name = "AlteraPersonagemFase2Servlet", urlPatterns = {"/AlteraPersonagemFase2Servlet"})
public class AlteraPersonagemFase2Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Fachada.getInstance().alterar(personagem);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AlteraPersonagemFase2Servlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>O personagem "+personagem.getNome()+" foi alterado com sucesso!!!!</h1>");
            out.println("<a href='ApresentaPersonagensServlet'>apresentar personagens</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
